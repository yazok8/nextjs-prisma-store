...
const dateFomatter = new Intl.DateTimeFormat("en", {dateStyle:"medium"});
...
return(
    ...
    <Section>
        <Row>
            ...
            <Column>
                <Text className="mb-0 text-gray-500 whitespace-nowrap text-nowrap mr-4">
                    Purchased On</Text>
                <Text className="mt-0 mr-4">{dateFomatter.format(order.createdAt)}</Text>
            </Column>
            <Column>
                <Text className="mb-0 text-gray-500 whitespace-nowrap text-nowrap mr-4">
                    Price Paid</Text>
    ...
    <Row>
        <Column className="text-gray-500 mb-0">{product.description}</Column>
    </Row>
    </Section>
    </>
)
